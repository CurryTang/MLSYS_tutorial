...
> 🧭 **核心知识全景导览**
> - **市场架构与参与者生态**：一级市场 (IPO/融资) vs 二级市场 (流动性/定价) ｜ 场内撮合 (CME/NYSE) vs 场外定制 (OTC) ｜ 买方 (对冲/资管/养老金) vs 卖方 (投行) vs 做市商 (Jane Street/Citadel)
> - **基础资产类别全貌**：股票 (所有权凭证与融券做空机制) ｜ 固定收益 (国债/信用利差/收益率曲线倒挂) ｜ ETF (一级市场实物申赎 AP 套利机制) ｜ 外汇与商品 (全球流动性/Contango/Backwardation)
> - **衍生品全景生态与对冲**：远期与期货 (农业起家/清算所履约/盯市) ｜ 互换 (利率互换 IRS/信用违约 CDS/2008次贷) ｜ 期权核心机理 (定金与保险/权利不对称) ｜ 希腊字母体系 ($\Delta, \Gamma, \Theta, \mathcal{V}$) ｜ 波动率曲面 (1987股灾后的崩盘恐惧 Skew)
> - **资产配置与投资哲学**：分散化 (金融唯一的免费午餐) ｜ 传统 60/40 组合的隐形陷阱 (股票贡献 90%+ 波动) ｜ 桥水全天候与风险平价 (按风险贡献分蛋糕)
...
| 阶段 | 参与主体 | 核心套利动作 | 市场定价反馈 |
| :--- | :--- | :--- | :--- |
| **1. 溢价出现** | 二级市场散户 / 机构 | 市场需求旺盛，ETF 市价升至 \$102，高于底层股票资产净值 (\$100) | 产生 \$2 / 份的无风险套利窗口 |
| **2. 买入成份股** | 授权参与商 (AP / 做市商) | AP 在现货股市按指数权重买入价值 \$100 的一篮子成份股 | 股票市场现货买盘微增 |
| **3. 实物申购** | 基金公司 (BlackRock / Vanguard) | AP 将一篮子成份股交付基金公司，换取新铸造的 1 份 ETF 份额 (Creation) | 基金管理资产净值增加，ETF 总份额扩大 |
| **4. 抛售平价** | 二级市场 | AP 将新生成的 ETF 份额在二级市场以 \$102 卖出，锁定 \$2 净利润 | 二级市场 ETF 供给激增，市价被平抑回 \$100 |
